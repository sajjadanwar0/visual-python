...
styles = {"pre": {"border": "thin lighgrey solid", "overflowX": "scroll"}}
...
# Need to keep track of the button clicks to see if there is a change
...
app.layout = html.Div([
    ...
    dcc.Checklist(
        ...
        options=[{
            "label": i,
            "value": i, } for i in transmission_types],
        value=transmission_types,
        labelStyle={"display": "inline-blocks"},
...
def update_figure(year_range, transmission_list, selectedData, n_clicks):
    ...
    if n_clicks > total_clicks:
        # From here - https://community.plotly.com/t/applying-only-newest-selectedpoints-in-multiple-graphs-or-clicks
